...
public class Rider implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.out.println("Rider " + id + " is waiting !!");
            ...
            System.out.println("Rider " + id + "got onboard.");            //acquire the bus semaphore to get on board
            ...
            // Logger.getLogger(Lab_03.class.getName()).log(Level.SEVERE, "Rider" + id + "'s thread got interrupted !!", ex);
